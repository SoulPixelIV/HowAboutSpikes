...
void main() {
    ...
    vec2 tc_rot = (v_vTexcoord-vec2(0.5))*rotation_matrix+vec2(0.5);
    vec4 light_color = texture2D(light, sprite_coords.st + tc_rot * (sprite_coords.pq - sprite_coords.st) ); //New single texture page
